...
function initAdmin(axios, moment, socket, Noty) {
  ...
  axios.get('/admin/orders', {
    ...
    console.log("hasil : ".concat(JSON.stringify(orders)));
...
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_admin__WEBPACK_IMPORTED_MODULE_3__);
...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (response) {
...
if (adminArea.includes('admin')) {
  _admin__WEBPACK_IMPORTED_MODULE_3___default()((axios__WEBPACK_IMPORTED_MODULE_0___default()), (moment__WEBPACK_IMPORTED_MODULE_1___default()), socket, (noty__WEBPACK_IMPORTED_MODULE_2___default()));
